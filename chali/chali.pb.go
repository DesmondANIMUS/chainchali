...
/*
Package chali is a generated protocol buffer package.
...
func init() {
	proto.RegisterType((*Block)(nil), "chali.Block")
	proto.RegisterType((*AddBlockRequest)(nil), "chali.AddBlockRequest")
	proto.RegisterType((*AddBlockResponse)(nil), "chali.AddBlockResponse")
	proto.RegisterType((*GetBlockchainRequest)(nil), "chali.GetBlockchainRequest")
	proto.RegisterType((*GetBlockchainResponse)(nil), "chali.GetBlockchainResponse")
}
...
func (c *blockchainClient) AddBlock(ctx context.Context, in *AddBlockRequest, opts ...grpc.CallOption) (*AddBlockResponse, error) {
	...
	err := grpc.Invoke(ctx, "/chali.Blockchain/AddBlock", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *blockchainClient) GetBlockchain(ctx context.Context, in *GetBlockchainRequest, opts ...grpc.CallOption) (*GetBlockchainResponse, error) {
	...
	err := grpc.Invoke(ctx, "/chali.Blockchain/GetBlockchain", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Blockchain_AddBlock_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/chali.Blockchain/AddBlock",
	}
...
func _Blockchain_GetBlockchain_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/chali.Blockchain/GetBlockchain",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Blockchain_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "chali.proto",
}

func init() { proto.RegisterFile("chali.proto", fileDescriptor0) }

var fileDescriptor0 = []byte{
	// 229 bytes of a gzipped FileDescriptorProto
	,
}
